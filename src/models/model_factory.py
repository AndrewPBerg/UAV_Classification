    ...
    def create_model(
        ...
        # handle models downloaded from torch-hub
            ...
            if model_type.startswith('vit'):
                model = TransformerModel._create_vit_model(model_type, num_classes, input_shape)
            elif model_type.startswith("resnet"):
                model = CNNModel._create_resnet_model(model_type, num_classes, input_shape)
            elif model_type.startswith("mobilenet"):
                model = CNNModel._create_mobilenet_model(model_type, num_classes, input_shape)
            elif model_type.startswith("efficientnet"):
                model = CNNModel._create_efficientnet_model(model_type, num_classes, input_shape)
            else:
